...
export default function Sidebar() {
  ...
  return (
    <div className="w-56 bg-white border-r border-gray-100 flex flex-col h-screen fixed left-0 top-0 z-10">
      ...
      <div className="px-5 py-5 border-b border-gray-100">
        ...
        <p className="text-xs text-gray-400 mt-1 ml-10">For Malaysian Graduates</p>
      </div>
